...
def migrate(cr, version):
    ...
    Some upgraded databases may have the Python field definition already loaded
    while the physical column is still missing. That causes hr.attendance reads
    to fail with UndefinedColumn. We add the column defensively if needed.
    """
